print("loading NullRDC rime-abc dissector")
...
function rime_proto.dissector(buffer,pinfo,tree)
	...
	local data_tree = tree:add(rime_proto, buffer(11, buffer:len() - 13), "Payload")

	pinfo.cols.info = "Rime abc on channel " .. buffer(9,2):le_uint()
